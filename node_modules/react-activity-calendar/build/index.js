...
function groupByWeeks(days, weekStart = 0 // 0 = Sunday
  ...
  const firstDate = parseISO__default['default'](days[0].date);
  ...
  const paddedDays = [...Array(differenceInCalendarDays__default['default'](firstDate, firstCalendarDate)).fill(undefined), ...days];
